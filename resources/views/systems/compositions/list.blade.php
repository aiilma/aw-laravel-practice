...
@section('content')
    <div class="container">
                <div class="content">
                            ...
                            <div class="col-6 col-xl-4 comparea">
                                <div class="card">
                                    ...
                                    <div class="card-block compcard-placer-links">
                                        <a class="comp-link-req @if (Auth::check() == false 
                                                                    || Auth::user()->isBindedSteam() == false) disabled @endif"
                                            href="{{ route('compositions-fbuy', $composition->id) }}"><span class="oi oi-cart" aria-hidden="true"></span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    {{-- Pagination --}}
                    {{ $compositions->links('layouts.pagination') }}
...
@push('scripts') <script src="{{asset('js/compositions_listing.js')}}"></script>@endpush