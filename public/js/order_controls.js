...
try {
  ...
  $(document).ready(function () {
    ...
    $('.aw__icon__confirm').on('click', function (e) {
      // form data object
      var orderData = {
      ...
      $.ajax({
        ...
        success: function success(result) {
          ...
          if (result.done === true) {
            ...
            $('.navbar-nav .aw__ui__balance').html(result.html.uiBalance); // объект кфг уведомления
    ...
    $('.aw__icon__deny').on('click', function (e) {
      // form data object
      var orderData = {
        _orderHash: $(e.target).parents(".row__user__current__order").children('input[name="_orderHash"]').val()
      }; // request
      ...
      $.ajax({
        ...
        success: function success(result) {
          if (result.done === true) {
            $(e.target).parents(".row__user__current__order").remove(); // объект кфг уведомления
    ...
    $('.user__order__dataset').on('click', '.aw__btn__check__order__info', function (e) {
      ...
      var visualizationHtmlPatt = $('.aw__visualization__variants>.aw__form__component').html();
      var backgroundHtmlPatt = $('.aw__user__bg__variant>.aw__form__component').html(); // request
      ...
      $.ajax({
        ...
        success: function success(result) {
          ...
          console.log(result); // if data is received...
